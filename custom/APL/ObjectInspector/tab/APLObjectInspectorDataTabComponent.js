class APLObjectInspectorDataTabComponent extends BestAppsObjectInspectorPropertiesTabComponent {
    static tag = 'apl-object-inspector-data-tab-component';

    static EVENT_TAB_JSON_CHANGED = 'event.tab.json.changed';
    ...
    initJSONEditor() {
        ...
        div.classList.add('jsoneditor');
        this.element.wrapper.appendChild(div);
        this.element.jsoneditor = div;
        const options = {
            mode: 'tree',
            "indentation": 2,
            onChangeJSON: ((json) => {
                me.sendPropertyChanged({
                    tabName: me.options.tabName,
                    key: me.name,
                    type: me.constructor.EVENT_TAB_JSON_CHANGED,
                    data: {
                        json
                    }
                });
...
customElements.define(APLObjectInspectorDataTabComponent.tag, APLObjectInspectorDataTabComponent);